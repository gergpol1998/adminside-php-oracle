...
//query MAX ID
$sql = "SELECT MAX(GROUP_ID) AS LAST_ID FROM TB_GROUP";
$result = oci_parse($conn, $sql);
oci_execute($result);
$row = oci_fetch_assoc($result);
$maxId = substr($row['LAST_ID'], -1); //ดึงค่าไอดีล่าสุดจากตารางข้อมูลที่จะบันทึก

$maxId = ($maxId + 1);  //บวกค่าเพิ่มอีก 1

$maxId = substr("00000".$maxId, -1);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Manage <sub>Permission</sub></h1>
                    <hr>
                    <div class="row">
                        <div class="col-sm-6" >
                            ...
                            <form class="form"   action="insert_perm.php" method="post"> <br>
                                
                                <label>รหัสตำแหน่ง:</label>
                                <input type="text" name="roleid" class="form-control" value="<?php echo $nextId; ?>" readonly> <br>

                                <label>ชื่อตำแหน่ง:</label>
                                <input type="text" name="rolename" class="form-control" > <br>

                                <label>สิทธิ์การเข้าถึง:</label><br>
                                <input type="checkbox"  name="perm[]" value="1">ADD_STAFF 
                                <input type="checkbox" name="perm[]" value="2">ADD_PRODUCT
                                <input type="checkbox" name="perm[]" value="3">CHECK RECIEPT
                                <input type="checkbox" name="perm[]" value="4">VIEW_REPORT
                                <input type="checkbox" name="perm[]" value="5">ADD_PERMISSION
                                </select><br><br>
