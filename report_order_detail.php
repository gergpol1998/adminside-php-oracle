                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h3 class="m-0 font-weight-bold text-primary">รายการสินค้าตามใบสั่งซื้อ</h3><br>
                                <div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * 
                                            FROM TB_ORDER,ORDER_LIST,CUSTOMER,CM_ADDRESS,PRODUCT,PRODUCTDETAIL
                                            WHERE (TB_ORDER.ORDER_NO = ORDER_LIST.ORDER_NO AND CUS_ID = CUSTOMER_ID AND CM_ID = CUSTOMER_ID
                                            AND PRODUCT_ID = PROID AND ORDER_PRODUCT = PROID AND ORDER_PRO_NO = PRODUCTDETAIL.NO) AND TB_ORDER.ORDER_NO = '$ids'
                                            ORDER BY PRODUCT_ID DESC";
                                            $result = oci_parse($conn, $sql);
                                            oci_execute($result);
                                            $sum_total = 0;
                                            while ($row = oci_fetch_array($result)) {
                                                $sum_total = $row['ORDER_SUM'];
