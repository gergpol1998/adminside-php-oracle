...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <table class="table table-hover">
            ...
            <?php
            $sql = "SELECT PRODUCT_ID,PRODUCT_NAME,TYPE_NAME,PRODUCT_DATE,COMPANY_NAME,BRAND_NAME,SEASON_NAME,
            NAME,COLOR_NAME,SELL,QUANTITY,IMAGE
            FROM PRODUCT,PRODUCTDETAIL,TYPE,COMPANY,BRAND,SEASON,COLOR,SIZEPRODUCT
            WHERE (PRODUCT_ID=PRODUCTDETAIL.PROID AND PRODUCT.PRODUCT_TYPEID=TYPE_ID AND 
            PRODUCT.PRODUCTBRAND_ID = BRAND_ID AND PRODUCT.PRODUCT_COLORID = COLOR_ID AND
            COM_ID=COMPANY_ID AND PRODUCT.PRODUCT_SEASONID=SEASON_ID AND
            PRODUCTDETAIL.SIZEID=SIZEPRODUCT.ID)ORDER BY PRODUCT_ID ";
            ...
            ?>
                <tr>
                    ...
                    <td><?= $row['SELL'] ?> </td>
                    <td><?= $row['QUANTITY'] ?> </td>
                    <td><img src="image/<?= $showimage?>" width="80px" height="100px"> </td>
                </tr>
            <?php
            }
            oci_close($conn);
