                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h3 class="m-0 font-weight-bold text-primary">รายงานยอดขาย</h3><br>
                                <div>
                                ...
                                <br>
                                <div>
                                    <form name="form2" method="POST" action="reports.php">
                                        <div class="row">
                                            <div class="col-sm-2">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            if(($dstart != "") && ($dtend != "")){
                                                ...
                                                $sql = "SELECT TO_DATE(ORDER_DATE,'dd-mm-yyyy') AS ORDER_DATE,
                                                SUM(ORDER_SUM) AS TOTAL
                                                FROM TB_ORDER
                                                WHERE ORDER_STATUS = 2 AND ORDER_DATE BETWEEN TO_DATE('" . $add_datestart . "','dd-mm-yy') AND  TO_DATE('" . $add_dateend . "','dd-mm-yy')
                                                GROUP BY TO_DATE(ORDER_DATE,'dd-mm-yyyy') 
                                    ...
                                    <b>ยอดรวมสุทธิ <?=number_format($total,2)?> บาท</b>
                                    <?php
