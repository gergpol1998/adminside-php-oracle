...
$code = "PRO"; //กำหนดอักษรนำหน้า
$yearMonth = substr(date("Y")+543,-2).date("m"); //ดึงค่าปี เดือน ปัจจุบัน
//query MAX ID
$sql = "SELECT MAX(PRODUCT_ID) AS LASTPRO_ID,MAX(PRODUCTDETAIL.NO) AS LASTNO_ID
FROM PRODUCT,PRODUCTDETAIL
WHERE PRODUCT_ID = PROID";
$result = oci_parse($conn, $sql);
oci_execute($result);
$row = oci_fetch_assoc($result);
$maxId = substr($row['LASTPRO_ID'], -3); //ดึงค่าไอดีล่าสุดจากตารางข้อมูลที่จะบันทึก
$maxId2 = substr($row['LASTNO_ID'], -3);

$maxId = ($maxId + 1);  //บวกค่าเพิ่มอีก 1
$maxId2 = ($maxId2 + 1);

$maxId = substr("00000".$maxId, -3);
$maxId2 = substr("00000".$maxId2, -3);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include "menu.php";?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Manage <sub>Product</sub></h1>
                    <hr>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <form class="form" action="insert_product.php" method="post" enctype="multipart/form-data"> <br>
                                ...
                                <input type="text" name="pid" class="form-control" value="<?php echo $nextId; ?>" readonly  placeholder="รหัสสินค้า..." require> <br>

                                <label>ลำดับสินค้า:</label>
                                <input type="text" name="pno" class="form-control" value="<?php echo $nextId2; ?>" readonly placeholder="ลำดับสินค้า..." require> <br>
                                ...
                                <label>รูปภาพ:</label>
                                <input type="file" name="file1" class="form-control" require> <br>
