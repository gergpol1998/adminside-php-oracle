                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h3 class="m-0 font-weight-bold text-primary">รายงานสินค้าที่ขายไม่ได้</h3><br>
                                <div>
                                ...
                                <br>
                                <div>
                                    <form name="form2" method="POST" action="report_product_no.php">
                                        <div class="row">
                                            <div class="col-sm-2">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            $add_dateend = date('d-m-Y', strtotime($dtend . "+1 days"));


                                            if (($dstart != "") && ($dtend != "")) {
                                                echo "ค้นหาจากวันที่ $dstart ถึง $dtend ";
                                                $sql = "SELECT PRODUCT_ID,PRODUCT_NAME,IMAGE
                                                FROM PRODUCT,PRODUCTDETAIL
                                                WHERE (PROID = PRODUCT_ID) AND PRODUCT_ID NOT IN 
                                                    (SELECT ORDER_PRODUCT 
                                                    FROM TB_ORDER,ORDER_LIST
                                                    WHERE (ORDER_LIST.ORDER_NO = TB_ORDER.ORDER_NO) AND
                                                ...
                                                WHERE (PROID = PRODUCT_ID) AND PRODUCT_ID NOT IN 
                                                    (SELECT ORDER_PRODUCT 
                                                    FROM TB_ORDER,ORDER_LIST
                                                    WHERE (ORDER_LIST.ORDER_NO = TB_ORDER.ORDER_NO))
                                                    ORDER BY PRODUCT_DATE DESC";
                                            }
